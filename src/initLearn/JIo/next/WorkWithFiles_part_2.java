package initLearn.JIo.next;

import javax.swing.*;
import java.io.*;
import java.nio.charset.StandardCharsets;

import static initLearn.JIo.next.WorkWithFiles_part_1.*;
...
class WorkWithFiles_part_2 extends JFrame {
    ...
    void dataTransfer() throws IOException {
        ...
        while (addCurrentFile) {
            for (fileCount = 0; fileCount < requireOfFiles; fileCount ++) {
                ...
                FileInputStream is = new FileInputStream (needFiles[fileCount]);
